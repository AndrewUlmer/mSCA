...
if __name__ == "__main__":
    ...
    for sparsity in [10.0, 15.0, 20.0, 30.0, 40.0]:
        ...
        for i in range(len(train_idxs[k0])):
            ...
            msca, losses = mSCA(
                ...
                linear=True,
                loss_func="Gaussian",
                lam_sparse=sparsity,  # args["lam_sparse"],
                lam_region=0.0,
                post_hoc_epoch=1000,
                cd_rate=0.5,
                cd_mode="both",
            ...
            msca.save(f"{experiment_path}msca_{i}_sparsity={sparsity:.4f}.pt")

            # Save the losses
            torch.save(
                losses, f"{experiment_path}losses_{i}_sparsity={sparsity:.4f}.pt"
            )
