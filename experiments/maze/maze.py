...
if __name__ == "__main__":
    ...
    experiment_path = "./experiments/maze/sparsity_sweep_orth/"
    param_path = "params.txt"

    # IMPORTANT: ADD DATA LOADING CODE HERE
    data = torch.load("./experiments/maze/data/x.pt", weights_only=False)
    X = {
    ...
    #                 x=data["move_idxs"][trial_idx] - msca.filter_len,
    #                 color="black",
    #                 ls=":",
    #             )
    #             axs[i, reach_dir].axvline(
    ...
    #         f"./experiments/maze/sparsity_sweep_orth/bootstrapped_separate_n_components=20_lam_sparse={sparsity:.3f}.pt"
    #     )
