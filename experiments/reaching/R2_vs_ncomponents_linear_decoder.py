"""
Compute BCV pseudo-R² vs n_components — nonlinear-linear (Poisson GLM decoder).

Run from the project root:
    python experiments/reaching/R2_vs_ncomponents_linear_decoder.py
...
COND_DIR   = "./experiments/reaching/results/sweep-n_component/nonlinear-linear"
OUT_DIR    = "./experiments/reaching/results/sweep-n_component/r2/nonlinear-linear"
LOSS_FUNC  = "poisson"
